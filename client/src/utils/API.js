...
export default {
    ...
    getElections: function () {
        return axios.get(BASEURL + "/elections?key=" + APIKEY);
    },
    ...
    getVoterInfo: function (address) {
        return axios.get(BASEURL + "/voterinfo?key=" + APIKEY + "&address=" + address);
    },
    // Get all reps for voter
    // Required zipcode and optional address for more results
    getRepInfo: function (zip) {
        return axios.get(BASEURL + "/representatives?key=" + APIKEY + "&address=" + zip);
    },
    // Get signed in user
    getUser: function (id) {
        return axios.get("/" + id);
